...
start-choose-library = Choisissez une bibliothèque
...
search-by-title-download-button-with_-format = Télécharger { $format }
search-by-title-download-button = Télécharger
