...
gutetenberg-call-to-action = खोज क्वेरी इनपुट करें
gutenberg-listing-previous = 👈 पिछला
gutenberg-listing-next = 👉 अगला
gutenberg-listing-book-title = "{ $query }" के लिए खोज परिणाम
